...
export class SearchService {
  ...
  async findProductsMatchingQuery(
  ...
  async getFuzzyAutocompleteResults(
    query: SearchRequestDto,
    options?: SearchAutocompleteOptionsDto,
  ) {
    ...
    const similarityThreshold =
      options?.similarityThreshold! || defaultOptions.similarityThreshold!;
    ...
    const matchedProducts: (Product & { similarity: number })[] = await this
      .prisma.$queryRaw`
