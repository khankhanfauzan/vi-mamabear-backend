...
describe('GuardrailService', () => {
  ...
  describe('Input Guardrail (check)', () => {
    ...
    describe('PRESCRIPTION_REQUEST', () => {
      ...
      it.each(prescriptionInputs)('should block prescription request: %s', (input) => {
        const result = service.check(input);
        expect(result).not.toBeNull();
    ...
    describe('OUT_OF_SCOPE', () => {
      ...
      it.each(outOfScopeInputs)('should block out of scope input: %s', (input) => {
        const result = service.check(input);
        expect(result).not.toBeNull();
  ...
  describe('Output Guardrail (checkOutput)', () => {
    describe('MEDICAL_DIAGNOSIS', () => {
      ...
      it.each(diagnosisOutputs)('should block medical diagnosis output: %s', (output) => {
    ...
    describe('SPECIFIC_PRESCRIPTION', () => {
      ...
      it.each(prescriptionOutputs)('should block specific prescription output: %s', (output) => {
        const result = service.checkOutput(output);
        expect(result).not.toBeNull();
